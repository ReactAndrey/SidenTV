...
public class VideoDbBuilder {
    ...
    public List<ContentValues> buildMedia(JSONObject jsonObj) throws JSONException {
        ...
        for (int i = 0; i < categoryArray.length(); i++) {
            ...
            Log.i("mdsizesss=",String.valueOf(i+1) + category.toString());
...
//                }
                ...
                if(categoryName.contains("Episodes"))
                ...
                String videoUrl = (String) video.optString(TAG_SOURCES);; // Get the first video only.
                ...
                String mid = video.optString(TAG_MID);
                String pid = video.optString(TAG_PID);
                ContentValues videoValues = new ContentValues();
                videoValues.put(VideoContract.VideoEntry.COLUMN_CATEGORY, categoryName);

                // Add MID,PID
//                videoValues.put(VideoContract.VideoEntry.COLUMN_MID, String.valueOf(j+1));
                //videoValues.put(VideoContract.VideoEntry.COLUMN_PID, "0");
//                if(categoryName.contains("Recently Added") && j==1)
//                    videoValues.put(VideoContract.VideoEntry.COLUMN_PID, "1");
//                else
//                    videoValues.put(VideoContract.VideoEntry.COLUMN_PID, "0");

                videoValues.put(VideoContract.VideoEntry.COLUMN_MID, mid);
                videoValues.put(VideoContract.VideoEntry.COLUMN_PID, pid);
...
//                if(category.toString().contains("Recently Added"))
//                    videoValues.put(VideoContract.VideoEntry.COLUMN_VIDEO_URL, videoUrl+"aaa");
//                else
        ...
        Log.i("videoinsertsize=",String.valueOf(videosToInsert.size()));
