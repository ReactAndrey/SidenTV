...
public final class VideoCursorMapper extends CursorMapper {
    ...
    protected void bindColumns(Cursor cursor) {
        ...
        midIndex = cursor.getColumnIndex(VideoContract.VideoEntry.COLUMN_MID);
        pidIndex = cursor.getColumnIndex(VideoContract.VideoEntry.COLUMN_PID);
