...
public class VideoDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        //Log.i("creat database","database1");
        // Create a table to hold videos.
        final String SQL_CREATE_VIDEO_TABLE = "CREATE TABLE " + VideoEntry.TABLE_NAME + " (" +
                VideoEntry._ID + " INTEGER PRIMARY KEY," +
                VideoEntry.COLUMN_CATEGORY + " TEXT NOT NULL, " +
                VideoEntry.COLUMN_MID + " TEXT NOT NULL, " +
                VideoEntry.COLUMN_PID + " TEXT NOT NULL, " +
                //VideoEntry.COLUMN_VIDEO_URL + " TEXT UNIQUE NOT NULL, " + // Make the URL unique.
                VideoEntry.COLUMN_VIDEO_URL + " TEXT NOT NULL, " + // Make the URL unique.
